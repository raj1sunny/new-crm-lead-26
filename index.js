...
async function getTemplate(Id) {
    ...
    if (Id.typeId && Id.formId) {
        ...
        await fetch(`https://api.wolfeocrm.com/v1/setting/${Id.typeId}/template/${Id.formId}`, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
                'authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJMVENCV1M4RkRVTkdTMDNUIiwiaXNzIjoiaHR0cHM6Ly9hcGkuaWxvZ2dlcnouY29tL2FwaS92MS9sb2dpbiIsImlhdCI6MTY3NzkxNjM1NiwiZXhwIjoxNjc3OTE5OTU2LCJuYmYiOjE2Nzc5MTYzNTYsImp0aSI6IkxUQ0JXUzhGRFVOR1MwM1QxNjc3OTE2MzU2In0.SkhBn-3Rf8SPrpH_cQU7MKWCLlchHT-vqkAabf9d7zE'
            }
        }).then(async (res) => {
            data = await res.json();
        })
